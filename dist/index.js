...
var _window$WPFC = window.WPFC,
    ajaxurl = _window$WPFC.ajaxurl,
    data = _window$WPFC.data,
    _window$WPFC$lastUpda = _window$WPFC.lastUpdated,
    lastUpdated = _window$WPFC$lastUpda === void 0 ? 0 : _window$WPFC$lastUpda,
    _window$WPFC$nameSpac = _window$WPFC.nameSpace,
    nameSpace = _window$WPFC$nameSpac === void 0 ? 'FC' : _window$WPFC$nameSpac,
    _window$WPFC$page = _window$WPFC.page,
    page = _window$WPFC$page === void 0 ? 'default' : _window$WPFC$page;
var LS = localStorage;
...
var clearLocalStorage = function clearLocalStorage(cachePrefix) {
...
var saveEventDataLocally = function saveEventDataLocally(url, cacheName, _cacheTime) {
  return new Promise(function (resolve, reject) {
    var cacheTime = Number(_cacheTime);
    var lastCacheTime = Number(LS.getItem(cacheName));
    ...
    var eventData = LS.getItem("".concat(nameSpace, "/").concat(url));
    ...
    if (!eventData) {
      ...
      request.onload = function () {
        if (request.status >= 200 && request.status < 400) {
          LS.setItem("".concat(nameSpace, "/").concat(url), request.responseText);
          resolve();
        } else {
          reject();
        }
...
var dataToKVP = function dataToKVP(data) {
...
var getAjaxUrl = function getAjaxUrl(data) {
  return "".concat(ajaxurl, "?").concat(dataToKVP(data).join('&'));
};
/**
...
var getAllLocallySavedEvents = function getAllLocallySavedEvents(cb) {
  var allEventsInLocalStorage = Object.keys(LS).reduce(function (acc, next) {
    if (next.indexOf("".concat(nameSpace, "/")) > -1) {
      var events = [];
      ...
      try {
        ...
        _toConsumableArray(events).forEach(function (event) {
...
var calendarEl = document.getElementById('full-calendar'); // styling hook

calendarEl.classList.add("fc-".concat(page.toLowerCase()));
...
var now = new Date();
var todaysDate = formatDate(now);
document.addEventListener('DOMContentLoaded', function () {
  var calendarEl = document.getElementById('full-calendar');
  var calendar = new _fullcalendar_core__WEBPACK_IMPORTED_MODULE_0__["Calendar"](calendarEl, {
    events: function events(_ref, successCallback, failureCallback) {
      ...
      }), nameSpace, lastUpdated).then(function () {
        return getAllLocallySavedEvents(successCallback);
    ...
    initialView: LS.getItem("".concat(nameSpace, "_DEFAULT_VIEW")) !== null ? LS.getItem("".concat(nameSpace, "_DEFAULT_VIEW")) : 'listMonth',
    nowIndicator: true,
    firstDay: 1,
    plugins: [_fullcalendar_list__WEBPACK_IMPORTED_MODULE_2__["default"], _fullcalendar_daygrid__WEBPACK_IMPORTED_MODULE_1__["default"], _fullcalendar_timegrid__WEBPACK_IMPORTED_MODULE_3__["default"]],
    ...
    weekNumbers: true,
    eventDidMount: function eventDidMount(data) {
      if (data.backgroundColor) {
        var color = data.backgroundColor;

        if (!data.isFuture) {
          // convert hex to RGB
          var rgb = hexToRgb(color); // convert RGB to RGBA and change opacity to 50%
...
/*!***************************************************!*\
  !*** ./node_modules/@fullcalendar/core/preact.js ***!
  \***************************************************/
/*! exports provided: createPortal, createContext, flushSync, Component, Fragment, cloneElement, createElement, createRef, h, hydrate, isValidElement, options, render, toChildArray */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/*!**********************************************************!*\
  !*** ./node_modules/preact/compat/dist/compat.module.js ***!
  \**********************************************************/
/*! exports provided: Component, Fragment, createContext, createElement, createRef, Children, PureComponent, StrictMode, Suspense, SuspenseList, __SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED, cloneElement, createFactory, createPortal, default, findDOMNode, flushSync, forwardRef, hydrate, isValidElement, lazy, memo, render, startTransition, unmountComponentAtNode, unstable_batchedUpdates, useDeferredValue, useInsertionEffect, useSyncExternalStore, useTransition, version, useCallback, useContext, useDebugValue, useEffect, useErrorBoundary, useId, useImperativeHandle, useLayoutEffect, useMemo, useReducer, useRef, useState */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__(/*! /Users/simon/github/pacific-dragons/htdocs/app/plugins/wp-fullcalendar/index.js */"./index.js");
module.exports = __webpack_require__(/*! /Users/simon/github/pacific-dragons/htdocs/app/plugins/wp-fullcalendar/index.scss */"./index.scss");
