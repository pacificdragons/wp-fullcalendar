...
/* harmony import */ var _fullcalendar_list__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @fullcalendar/list */ "./node_modules/@fullcalendar/list/index.js");
...
var _window$WPFC = window.WPFC,
  ...
  nameSpace = _window$WPFC$nameSpac === void 0 ? "WPFC" : _window$WPFC$nameSpac,
  canCreateEvents = _window$WPFC.canCreateEvents,
  canEditEvents = _window$WPFC.canEditEvents,
  createEventNonce = _window$WPFC.createEventNonce;
 ...
 */
var createConfirmDialog = function createConfirmDialog() {
 ...
 */
var createMoveDialog = function createMoveDialog() {
 ...
 */
var createEvent = function createEvent(date) {
 ...
 */
var updateEventDate = function updateEventDate(eventId, nonce, newStartDate) {
  var formData = new FormData();
  ...
  return fetch(ajaxurl, {
    ...
    if (!result.success) {
      var _result$data;
      throw new Error(((_result$data = result.data) === null || _result$data === void 0 ? void 0 : _result$data.message) || "Failed to update event");
    }
    return result;
  });
};
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  if (canCreateEvents && createEventNonce) {
    createConfirmDialog();
    var dialog = document.getElementById("wpfc-create-event-dialog");
  ...
  var calendar = new _fullcalendar_core__WEBPACK_IMPORTED_MODULE_0__.Calendar(calendarEl, {
    ...
    datesSet: function datesSet(info) {
      LS.setItem("".concat(nameSpace, "_DEFAULT_VIEW"), info.view.type);
    },
    nowIndicator: true,
    firstDay: 1,
    plugins: [_fullcalendar_list__WEBPACK_IMPORTED_MODULE_1__["default"], _fullcalendar_daygrid__WEBPACK_IMPORTED_MODULE_2__["default"], _fullcalendar_timegrid__WEBPACK_IMPORTED_MODULE_3__["default"], _fullcalendar_interaction__WEBPACK_IMPORTED_MODULE_4__["default"]],
    ...
    eventDrop: function eventDrop(info) {
      var _info$event$extendedP;
      if (!canEditEvents || !((_info$event$extendedP = info.event.extendedProps) !== null && _info$event$extendedP !== void 0 && _info$event$extendedP.event_id)) {
        info.revert();
        return;
      }
    ...
    dateClick: function dateClick(info) {
      ...
      if (info.dateStr === lastClickDate && now - lastClickTime < DOUBLE_CLICK_DELAY) {
        ...
        if (canCreateEvents && createEventNonce) {
          ...
          var dateDisplay = new Date(info.dateStr).toLocaleDateString(undefined, {
            weekday: "long",
            year: "numeric",
            month: "long",
            day: "numeric"
  ...
  if (canEditEvents) {
    var moveDialog = document.getElementById("wpfc-move-event-dialog");
    moveDialog.addEventListener("close", function () {
      // Capture pending event before clearing (async operation follows)
      var moveInfo = pendingMoveEvent;
      pendingMoveEvent = null;
      if (moveDialog.returnValue === "confirm" && moveInfo) {
        updateEventDate(moveInfo.event.extendedProps.event_id, moveInfo.event.extendedProps.nonce, moveInfo.event.startStr.substring(0, 10)).then(function () {
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkwp_fullcalendar"] = self["webpackChunkwp_fullcalendar"] || [];
...
/******/ 	__webpack_require__.O(undefined, ["dist/index"], () => (__webpack_require__("./index.js")))
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["dist/index"], () => (__webpack_require__("./index.css")))
